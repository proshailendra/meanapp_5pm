...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_auth_guard__ = __webpack_require__("../../../../../src/app/services/auth.guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["BrowserModule"], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormsModule"], __WEBPACK_IMPORTED_MODULE_2__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_5__app_routing__["a" /* AppRoutingModule */]
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_6__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_7__services_auth_guard__["a" /* AdminAuthGuard */], __WEBPACK_IMPORTED_MODULE_7__services_auth_guard__["b" /* UserAuthGuard */]],
...
var routes = [
    ...
    { path: 'user', loadChildren: 'app/user/user.module#UserModule', canActivate: [__WEBPACK_IMPORTED_MODULE_2__services_auth_guard__["b" /* UserAuthGuard */]] },
    { path: 'admin', loadChildren: 'app/admin/admin.module#AdminModule', canActivate: [__WEBPACK_IMPORTED_MODULE_2__services_auth_guard__["a" /* AdminAuthGuard */]] }
];
...
var AuthService = (function () {
    ...
    AuthService.prototype.ValidateUser = function (user) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].apiAddress + '/auth', JSON.stringify(user), { headers: this.headers }).map(function (res) {
            return res.json();
...
var environment = {
    production: true,
    apiAddress: 'https://app5pm.herokuapp.com/api',
    cartName: 'cart',
    paymentGatewayUrl: 'https://test.payu.in/_payment',
    successUrl: 'https://app5pm.herokuapp.com/api/store/paymentstatus',
    failedUrl: 'https://app5pm.herokuapp.com/api/store/paymentstatus',
    key: 'gtKFFx',
    salt: 'eCwWELxi',
};
